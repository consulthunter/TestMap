...
public abstract class SemanticKernelGenerationProviderBase : IAiGenerationProvider
{
    ...
    private async Task<string> GenerateInferenceAsync(
        ...
        CancellationToken cancellationToken)
    {
        if (_kernel == null) throw new InvalidOperationException("Text generation service was not initialized.");
    ...
    {
        if (_kernel == null) throw new InvalidOperationException("Provider was not initialized.");
