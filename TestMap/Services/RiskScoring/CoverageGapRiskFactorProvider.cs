...
public class CoverageGapRiskFactorProvider : IRiskFactorProvider
{
    ...
    public Task<RiskFactorScore> ScoreAsync(MemberModel candidateMember, CancellationToken cancellationToken = default)
        => Task.FromResult(new RiskFactorScore(Factor, 0.0, "Coverage gap scoring is not implemented yet."));
}
