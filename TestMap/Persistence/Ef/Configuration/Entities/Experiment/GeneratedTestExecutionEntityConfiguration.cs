...
public class GeneratedTestExecutionEntityConfiguration : IEntityTypeConfiguration<GeneratedTestExecutionEntity>
{
    public void Configure(EntityTypeBuilder<GeneratedTestExecutionEntity> builder)
    {
        builder.ToTable("generated_test_executions");
        ...
        builder.Property(x => x.BaselineTestRunId).HasColumnName("baseline_test_run_id");
        ...
        builder.Property(x => x.ValidationRuleDecisionSnapshotJson).HasColumnName("validation_rule_decision_snapshot_json");
        builder.Property(x => x.ClassificationRuleDecisionSnapshotJson).HasColumnName("classification_rule_decision_snapshot_json");
