...
public static class ToolAttemptMappingExtensions
{
    public static ToolAttempt ToDomain(this ToolAttemptEntity entity) => new()
    {
        ...
        StdOutLogPath = entity.StdOutLogPath,
        StdErrLogPath = entity.StdErrLogPath,
        JsonlLogPath = entity.JsonlLogPath,
        ...
        TotalAttemptDurationSeconds = entity.TotalAttemptDurationSeconds,
    ...
    public static ToolAttemptEntity ToEntity(this ToolAttempt attempt) => new()
    {
        ...
        JsonlLogPath = attempt.JsonlLogPath,
