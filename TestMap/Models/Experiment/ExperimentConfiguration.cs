...
{
    /// <summary>
    /// Optional candidate selection strategy override for this experiment run.
    /// When omitted, the global generation target-selection configuration is used.
    /// </summary>
    public TargetSelectionStrategy? CandidateSelectionStrategy { get; set; }

    /// <summary>
    /// Shared generation approach used to shape generation and repair requests.
    /// Default: DefaultCoverageExtension
    /// </summary>
    public TestGenerationApproach GenerationApproach { get; set; } =
        TestGenerationApproach.DefaultCoverageExtension;

    /// <summary>
    /// Execution mode used to apply generated tests to the repository.
    /// Default: BasicCoverageExtension
    /// </summary>
