...
```sh
./TestMap.exe collect --config <PATH TO CONFIG FILE>
```
- _Note_: Update path to the file generated by `./TestMap.exe setup`

If this didn't work, try building and publishing yourself. See more details on building and publishing the tool [here.](#building-and-publishing)
