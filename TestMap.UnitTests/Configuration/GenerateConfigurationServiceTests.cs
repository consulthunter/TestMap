...
public sealed class GenerateConfigurationServiceTests : IDisposable
{
    ...
    public void GenerateConfiguration_WritesExpectedConfigFile()
    {
        ...
        Assert.Equal("desktop-linux", config.RuntimeConfig.Docker.DefaultContext);
        Assert.Equal("desktop-windows", config.RuntimeConfig.Docker.WindowsContext);
        Assert.Equal(SetupService.ValidationImageName, config.RuntimeConfig.Docker.Images.ValidationSdkAll);
        Assert.Equal("testmap-agent-eval-codex:latest", config.RuntimeConfig.Docker.Images.AgentTools["codex"]);
        Assert.Equal("testmap-agent-eval-claude:latest", config.RuntimeConfig.Docker.Images.AgentTools["claude"]);
        Assert.Equal("testmap-agent-eval-copilot:latest", config.RuntimeConfig.Docker.Images.AgentTools["copilot"]);
        Assert.Equal("testmap-agent-eval-openhands:latest", config.RuntimeConfig.Docker.Images.AgentTools["openhands"]);
        Assert.Equal("testmap-agent-eval-mini-swe-agent:latest", config.RuntimeConfig.Docker.Images.AgentTools["mini-swe-agent"]);
        Assert.Equal("testmap-agent-eval-aider:latest", config.RuntimeConfig.Docker.Images.AgentTools["aider"]);
        Assert.Equal("testmap-agent-eval-gemini:latest", config.RuntimeConfig.Docker.Images.AgentTools["gemini"]);
        Assert.False(config.RuntimeConfig.Docker.Images.AgentTools.ContainsKey("antigravity"));
